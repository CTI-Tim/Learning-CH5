...
namespace Example3
{
    ...
    public class Contract : IContract, IDisposable
    {
        ...
        public Example3.IVolume Volume { get { return (Example3.IVolume)InternalVolume; } }
        private Example3.Volume InternalVolume { get; set; }
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            InternalVolume = new Example3.Volume(ComponentMediator, 8);

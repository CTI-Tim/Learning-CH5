...
namespace ContractExample
{
    public class Touchpanel
    {
        ...
        private VolumeControl _myVolumeControl;
        ...
        public Touchpanel(int IpId, ControlSystem cs)
        {
            ...
            _myVolumeControl = new VolumeControl(_myContract);
            MessageBroker.AddDelegate("MuteFb", _myVolumeControl.SetMuteFb);
            MessageBroker.AddDelegate("VolumeFb", _myVolumeControl.SetAnalogFb);
            ...
            //_myContract.Volume.VolumeFb((UShortInputSig sig, IVolume volume) => sig.UShortValue = 65535);

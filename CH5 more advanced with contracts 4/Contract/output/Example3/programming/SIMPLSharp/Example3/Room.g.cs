...
namespace Example3
{
    ...
    internal class Room : IRoom, IDisposable
    {
        ...
        private void Initialize(uint controlJoinId)
        {
            ...
            Button = new Example3.IButton[buttonList.Count];
            for (int index = 0; index < buttonList.Count; index++)
            {
                Button[index] = new Example3.Button(ComponentMediator, buttonList[index]); 
            }
        ...
        public void AddDevice(BasicTriListWithSmartObject device)
        {
            ...
            {
                ((Example3.Button)Button[index]).AddDevice(device);
            }
        }
        ...
        public void RemoveDevice(BasicTriListWithSmartObject device)
        {
            ...
            for (int index = 0; index < Button.Length; index++)
            {
                ((Example3.Button)Button[index]).RemoveDevice(device);
            }
        }
        ...
        public Example3.IButton[] Button { get; private set; }
        ...
        public void Dispose()
        {
            ...
            for (int index = 0; index < Button.Length; index++)
            {
                ((Example3.Button)Button[index]).Dispose();
            }

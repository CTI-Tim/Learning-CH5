...
namespace Example2
{
    ...
    public class Contract : IContract, IDisposable
    {
        ...
        public Example2.IRoom Room { get { return (Example2.IRoom)InternalRoom; } }
        private Example2.Room InternalRoom { get; set; }
        ...
        public Contract(BasicTriListWithSmartObject[] devices)
        {
            ...
            InternalRoom = new Example2.Room(ComponentMediator, 1);
